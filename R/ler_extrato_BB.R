...
extrato$categoria <- ifelse(grepl("Taxa Compra/Venda Ações", extrato$descricao, ignore.case = TRUE), "Taxa Compra/Venda Ações", extrato$categoria)

extrato$categoria <- ifelse(grepl("lanch", extrato$descricao, ignore.case = TRUE), "Lanches", extrato$categoria)

extrato$categoria <- ifelse(grepl("hamburg", extrato$descricao, ignore.case = TRUE), "Lanches", extrato$categoria)
...
extrato$categoria <- ifelse(grepl("gelato", extrato$descricao, ignore.case = TRUE), "Lanches", extrato$categoria)
...
extrato$categoria <- ifelse(grepl("Transferido da poupança", extrato$descricao, ignore.case = TRUE), "Resgate de Investimentos", extrato$categoria)

extrato$categoria <- ifelse(grepl("CHURRASCARIA", extrato$descricao, ignore.case = TRUE), "Restaurantes", extrato$categoria)

extrato$categoria <- ifelse(grepl("ippon", extrato$descricao, ignore.case = TRUE), "Carro - Manutenção", extrato$categoria)
...
extrato$categoria <- ifelse(grepl("Venda de ações", extrato$descricao, ignore.case = TRUE), "Venda de ações", extrato$categoria)
