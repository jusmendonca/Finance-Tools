...
extrato$categoria <- ifelse(grepl("outlet pr", extrato$descricao, ignore.case = TRUE), "Estacionamento", extrato$categoria)
extrato$categoria <- ifelse(grepl("celso ney r", extrato$descricao, ignore.case = TRUE), "Estacionamento", extrato$categoria)
...
extrato$categoria <- ifelse(grepl("vivianelucia", extrato$descricao, ignore.case = TRUE), "Cursos", extrato$categoria)
extrato$categoria <- ifelse(grepl("ba bela vista", extrato$descricao, ignore.case = TRUE), "Ópticas", extrato$categoria)
extrato$categoria <- ifelse(grepl("kaspersky", extrato$descricao, ignore.case = TRUE), "Assinaturas", extrato$categoria)
...
extrato$categoria <- ifelse(grepl("trigo rei", extrato$descricao, ignore.case = TRUE), "Padaria", extrato$categoria)
extrato$categoria <- ifelse(grepl("panificadora", extrato$descricao, ignore.case = TRUE), "Padaria", extrato$categoria)
extrato$categoria <- ifelse(grepl("padshalon", extrato$descricao, ignore.case = TRUE), "Padaria", extrato$categoria)
extrato$categoria <- ifelse(grepl("confeitaria", extrato$descricao, ignore.case = TRUE), "Padaria", extrato$categoria)
extrato$categoria <- ifelse(grepl("maillard", extrato$descricao, ignore.case = TRUE), "Padaria", extrato$categoria)
extrato$categoria <- ifelse(grepl("mix mateus", extrato$descricao, ignore.case = TRUE), "Supermercado", extrato$categoria)
extrato$categoria <- ifelse(grepl("papel e cia", extrato$descricao, ignore.case = TRUE), "Supermercado", extrato$categoria)
...
extrato$categoria <- ifelse(grepl("brasilprev seguros", extrato$descricao, ignore.case = TRUE), "Previdência Privada", extrato$categoria)
...
extrato$categoria <- ifelse(grepl("farma", extrato$descricao, ignore.case = TRUE), "Remédios", extrato$categoria)
extrato$categoria <- ifelse(grepl("pharma", extrato$descricao, ignore.case = TRUE), "Remédios", extrato$categoria)
...
extrato$categoria <- ifelse(grepl("sorvet", extrato$descricao, ignore.case = TRUE), "Sorveterias", extrato$categoria)
...
extrato$categoria <- ifelse(grepl("RESTAUR", extrato$descricao, ignore.case = TRUE), "Restaurantes", extrato$categoria)
...
extrato$categoria <- ifelse(grepl("hering", extrato$descricao, ignore.case = TRUE), "Roupas", extrato$categoria)
extrato$categoria <- ifelse(grepl("mmartan", extrato$descricao, ignore.case = TRUE), "Cama, mesa e banho", extrato$categoria)
extrato$categoria <- ifelse(grepl("mmartan", extrato$descricao, ignore.case = TRUE), "Cama, mesa e banho", extrato$categoria)
...
extrato$categoria <- ifelse(grepl("amore mio", extrato$descricao, ignore.case = TRUE), "Lanchonetes", extrato$categoria)
...
extrato$categoria <- ifelse(grepl("Alexsandro Souza Dias", extrato$descricao, ignore.case = TRUE), "Consertos", extrato$categoria)
extrato$categoria <- ifelse(grepl("DARF", extrato$descricao, ignore.case = TRUE), "Imposto de Renda", extrato$categoria)
extrato$categoria <- ifelse(grepl("MUNICIPIO DE", extrato$descricao, ignore.case = TRUE), "Impostos e Taxas Municipais", extrato$categoria)
...
extrato$categoria <- ifelse(grepl("puket", extrato$descricao, ignore.case = TRUE), "Roupas", extrato$categoria)
extrato$categoria <- ifelse(grepl("cresci e perdi", extrato$descricao, ignore.case = TRUE), "Roupas", extrato$categoria)
...
extrato$categoria <- ifelse(grepl("dm consultoria", extrato$descricao, ignore.case = TRUE), "Estética", extrato$categoria)
extrato$categoria <- ifelse(grepl("ernesto s ribeiro", extrato$descricao, ignore.case = TRUE), "Fisioterapeutas", extrato$categoria)
extrato$categoria <- ifelse(grepl("katiene rodrigues", extrato$descricao, ignore.case = TRUE), "Consultas Médicas", extrato$categoria)
extrato$categoria <- ifelse(grepl("centro de alergia", extrato$descricao, ignore.case = TRUE), "Consultas Médicas", extrato$categoria)
...
extrato$centro <- ifelse(extrato$categoria %in% c("Estacionamento", "Combustível", "Manutenção Carro", "Lavagem", "Licenciamento Anual", "Seguro"),
                         "Carro",
                         ifelse(extrato$categoria %in% c("Padaria", "Feira", "Supermercado", "Gás", "Energia Elétrica", "Água", "Internet", "Assinaturas", "IPTU", "Condomínio"),
                                "Despesas domésticas regulares (exceto serviços de doméstica)",
                                ifelse(extrato$categoria %in% c("Pintura", "Material de Construção", "Consertos"),
                                       "Despesas domésticas extraordinárias",
                                       ifelse(extrato$categoria %in% c("Empregada", "Faxina"),
                                              "Serviços domésticos",
                                              ifelse(extrato$categoria %in% c("Plano de Saúde", "Consultas Médicas", "Remédios", "Tratamentos Fernanda", "Fisioterapeutas", "Dentistas", "Psicólogos", "Exames", "Ópticas"),
                                                     "Saúde",
                                                     ifelse(extrato$categoria %in% c("Doutorado Fernanda", "Escola Amélie", "Música Amélie", "Esporte Amélie", "Material Escolar Amélie", "Cursos"),
                                                            "Educação",
                                                            ifelse(extrato$categoria %in% c("Mesada Guilherme", "Supermercado Salvador"),
                                                                   ...
                                                                   ifelse(extrato$categoria %in% c("Telefone"),
                                                                          "Comunicação",
                                                                          ifelse(extrato$categoria %in% c("Juros", "Despesas de Transação com Ações", "Tarifas Bancárias", "Despesas Renda Fixa", "IOF", "Impostos e Taxas Municipais"),
                                                                                               ...
                                                                                               ifelse(extrato$categoria %in% c("Doações", "Presentes", "Loterias"),
                                                                                                      ...
                                                                                                      ifelse(extrato$categoria %in% c("Hospedagem", "Passagens", "Shows", "Eventos", "Cinema", "Teatro", "Bares"),
                                                                                                             ...
                                                                                                             ifelse(extrato$categoria %in% c("Roupas", "Cama, mesa e banho"),
                                                                                                                    ...
                                                                                                                    ifelse(extrato$categoria %in% c("Barbeiro", "Cosméticos", "Cabelereiro", "Estética"),
                                                                                                                           "Cuidados pessoais",
